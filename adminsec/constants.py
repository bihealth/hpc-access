...
RE_PROJECT_NAME_CHECK = rf"^{RE_NAME_CORE}$"
RE_GROUP_NAME_CHECK = rf"^{RE_NAME_CORE}$"
RE_PROJECT_FOLDER_CHECK = rf"^(/[a-zA-Z0-9-_]*)+{RE_NAME_CORE}$"
RE_GROUP_FOLDER_CHECK = rf"^(/[a-zA-Z0-9-_]*)+ag-{RE_NAME_CORE}$"
