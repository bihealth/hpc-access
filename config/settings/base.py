...
CRON_QUOTA_EMAIL_YELLOW_DOW = env.int("QUOTA_EMAIL_CRON", 1)
CRON_QUOTA_EMAIL_YELLOW_HOUR = env.int("QUOTA_EMAIL_CRON_HOUR", 0)
CRON_QUOTA_EMAIL_YELLOW_MINUTE = env.int("QUOTA_EMAIL_CRON_MINUTE", 20)

CRON_QUOTA_EMAIL_RED_HOUR = env.int("QUOTA_EMAIL_RED_HOUR", 0)
CRON_QUOTA_EMAIL_RED_MINUTE = env.int("QUOTA_EMAIL_RED_MINUTE", 10)

CRON_DISABLE_USERS_HOUR = env.int("DISABLE_USERS_HOUR", 0)
CRON_DISABLE_USERS_MINUTE = env.int("DISABLE_USERS_MINUTE", 15)

CRON_SYNC_LDAP_HOUR = env.int("SYNC_LDAP_HOUR", 0)
CRON_SYNC_LDAP_MINUTE = env.int("SYNC_LDAP_MINUTE", 5)
